...
class RetrieveData():
    ...
    def get_malicious_urls(self):
        ...
        df_urlbl = pd.read_csv('malicious_urls/rw_urlbl.txt', header=None)
...
# feature list. This list can then be returned and writen to a csv file.
	...
	def virus_total(self, result, url):
